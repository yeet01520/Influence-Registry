...
// NOTE: the SPA data globals (PROFILES_DATA, SENATE_DATA, ...) and the
// drawShareCard()/buildShareData() functions live in app.html, NOT index.html
// (index.html is the landing page). Default to app.html so the data-load wait
// can actually succeed; override with --url if needed.
const SPA_URL       = getArg('--url', 'http://localhost:8080/app.html');
