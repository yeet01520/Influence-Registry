...
V7_SCRIPT_PATH    = os.path.join(DATA_RAW_DIR, "fetch_fec_data.py")
CABINET_MEMBERS   = os.path.join(SCRIPT_DIR, "cabinet_members.json")
TARGET_MEMBERS    = os.path.join(DATA_RAW_DIR, "members.json")
TARGET_OUTPUT     = os.path.join(DATA_RAW_DIR, "fec_data_v7.json")
