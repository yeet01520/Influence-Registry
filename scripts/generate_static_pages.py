...
def render_donations(profile: dict, fec_record: dict) -> str:
    ...
    # Corporate / special interest total
    if "special_interest_total" in fec_record:
    ...
    for label, prof_key, fec_key in sectors:
        # If the FEC record has this sector key at all, FEC wins even if 0.
        ...
        elif donations.get(prof_key):
            row(label, donations[prof_key])
